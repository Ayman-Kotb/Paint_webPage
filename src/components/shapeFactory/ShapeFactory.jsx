...
class ShapeFactory {
    createShape( {shape , color , radius ,rx ,ry,  width ,strokeWidth , height , fillColor , x1 ,y1 ,x2 ,y2}){
        switch (shape){
            case "circle":
            ...
            case "ellipse":
                ...
                else return new myEllipse().create(color ,rx , ry, strokeWidth , fillColor)
            case "line":
            ...
            case "square":
                ...
                else return new Square().create(color, width , strokeWidth , fillColor)
            case "triangle":
